          ...
          <div class="row g-3">
            <div class="col-md-4">
              <div class="result-box">
                <div class="subtle mb-1">Predicted Class</div>
                <div class="fs-6 fw-semibold">{{ result }}</div>
              </div>
            </div>
            <div class="col-md-8">
              <div class="result-box">
                <div class="subtle mb-1">Label meaning</div>
                <div>Low Risk = balanced usage pattern.<br>High Risk = elevated digital wellbeing concern.</div>
              </div>
            </div>
          </div>
...
def predict():
    ...
    if request.method == "POST":
        try:
            ...
            data["usage_ratio"] = data["social_media_usage"] / (data["screen_time"] + 1e-5)
